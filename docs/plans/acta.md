...
- [x] Acceptance (automatable): `swift build -c release`, `bash Scripts/test.sh` (155 tests), `bash Scripts/lint.sh`, `bash Scripts/bundle.sh dev` all green
